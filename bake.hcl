...
target "enterprise_debian11_amd64" {
    tags=["aerospike/aerospike-server-enterprise-amd64:6.3.0.18", "aerospike/aerospike-server-enterprise-amd64:latest"]
    platforms=["linux/amd64"]
    context="./enterprise/debian11"
}

target "enterprise_debian11_arm64" {
    tags=["aerospike/aerospike-server-enterprise-arm64:6.3.0.18", "aerospike/aerospike-server-enterprise-arm64:latest"]
    platforms=["linux/arm64"]
    context="./enterprise/debian11"
}

target "federal_debian11_amd64" {
    tags=["aerospike/aerospike-server-federal-amd64:6.3.0.18", "aerospike/aerospike-server-federal-amd64:latest"]
    platforms=["linux/amd64"]
    context="./federal/debian11"
}

target "community_debian11_amd64" {
    tags=["aerospike/aerospike-server-community-amd64:6.3.0.18", "aerospike/aerospike-server-community-amd64:latest"]
    platforms=["linux/amd64"]
    context="./community/debian11"
}

target "community_debian11_arm64" {
    tags=["aerospike/aerospike-server-community-arm64:6.3.0.18", "aerospike/aerospike-server-community-arm64:latest"]
    platforms=["linux/arm64"]
    context="./community/debian11"
}
...
target "enterprise_debian11" {
    tags=["aerospike/aerospike-server-enterprise:6.3.0.18", "aerospike/aerospike-server-enterprise:6.3.0.18_1"]
    platforms=["linux/amd64,linux/arm64"]
    context="./enterprise/debian11"
}

target "federal_debian11" {
    tags=["aerospike/aerospike-server-federal:6.3.0.18", "aerospike/aerospike-server-federal:6.3.0.18_1"]
    platforms=["linux/amd64"]
    context="./federal/debian11"
}

target "community_debian11" {
    tags=["aerospike/aerospike-server:6.3.0.18", "aerospike/aerospike-server:6.3.0.18_1"]
    platforms=["linux/amd64,linux/arm64"]
    context="./community/debian11"
}
