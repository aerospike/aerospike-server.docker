...
target "enterprise_ubuntu22-04" {
    tags=["aerospike/aerospike-server-enterprise:6.4.0.23", "aerospike/aerospike-server-enterprise:6.4.0.23_1"]
    platforms=["linux/amd64,linux/arm64"]
    context="./enterprise/ubuntu22.04"
}

target "federal_ubuntu22-04" {
    tags=["aerospike/aerospike-server-federal:6.4.0.23", "aerospike/aerospike-server-federal:6.4.0.23_1"]
    platforms=["linux/amd64"]
    context="./federal/ubuntu22.04"
}

target "community_ubuntu22-04" {
    tags=["aerospike/aerospike-server:6.4.0.23", "aerospike/aerospike-server:6.4.0.23_1"]
    platforms=["linux/amd64,linux/arm64"]
    context="./community/ubuntu22.04"
}
