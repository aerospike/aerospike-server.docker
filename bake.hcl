...
target "enterprise_debian12_amd64" {
    tags=["aerospike/aerospike-server-enterprise-amd64:6.4.0.11", "aerospike/aerospike-server-enterprise-amd64:latest"]
    platforms=["linux/amd64"]
    context="./enterprise/debian12"
}

target "enterprise_debian12_arm64" {
    tags=["aerospike/aerospike-server-enterprise-arm64:6.4.0.11", "aerospike/aerospike-server-enterprise-arm64:latest"]
    platforms=["linux/arm64"]
    context="./enterprise/debian12"
}

target "federal_debian12_amd64" {
    tags=["aerospike/aerospike-server-federal-amd64:6.4.0.11", "aerospike/aerospike-server-federal-amd64:latest"]
    platforms=["linux/amd64"]
    context="./federal/debian12"
}

target "community_debian12_amd64" {
    tags=["aerospike/aerospike-server-community-amd64:6.4.0.11", "aerospike/aerospike-server-community-amd64:latest"]
    platforms=["linux/amd64"]
    context="./community/debian12"
}

target "community_debian12_arm64" {
    tags=["aerospike/aerospike-server-community-arm64:6.4.0.11", "aerospike/aerospike-server-community-arm64:latest"]
    platforms=["linux/arm64"]
    context="./community/debian12"
}
...
target "enterprise_debian12" {
    tags=["aerospike/aerospike-server-enterprise:6.4.0.11", "aerospike/aerospike-server-enterprise:6.4.0.11_1"]
    platforms=["linux/amd64,linux/arm64"]
    context="./enterprise/debian12"
}

target "federal_debian12" {
    tags=["aerospike/aerospike-server-federal:6.4.0.11", "aerospike/aerospike-server-federal:6.4.0.11_1"]
    platforms=["linux/amd64"]
    context="./federal/debian12"
}

target "community_debian12" {
    tags=["aerospike/aerospike-server:6.4.0.11", "aerospike/aerospike-server:6.4.0.11_1"]
    platforms=["linux/amd64,linux/arm64"]
    context="./community/debian12"
}
