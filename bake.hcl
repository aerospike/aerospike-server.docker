...
target "enterprise_debian11_amd64" {
    tags=["aerospike/aerospike-server-enterprise-amd64:6.1.0.31", "aerospike/aerospike-server-enterprise-amd64:latest"]
    platforms=["linux/amd64"]
    context="./enterprise/debian11"
}

target "federal_debian11_amd64" {
    tags=["aerospike/aerospike-server-federal-amd64:6.1.0.31", "aerospike/aerospike-server-federal-amd64:latest"]
    platforms=["linux/amd64"]
    context="./federal/debian11"
}

target "community_debian11_amd64" {
    tags=["aerospike/aerospike-server-community-amd64:6.1.0.31", "aerospike/aerospike-server-community-amd64:latest"]
    platforms=["linux/amd64"]
...
target "enterprise_debian11" {
    tags=["aerospike/aerospike-server-enterprise:6.1.0.31", "aerospike/aerospike-server-enterprise:6.1.0.31_1"]
    platforms=["linux/amd64"]
    context="./enterprise/debian11"
}

target "federal_debian11" {
    tags=["aerospike/aerospike-server-federal:6.1.0.31", "aerospike/aerospike-server-federal:6.1.0.31_1"]
    platforms=["linux/amd64"]
    context="./federal/debian11"
}

target "community_debian11" {
    tags=["aerospike/aerospike-server:6.1.0.31", "aerospike/aerospike-server:6.1.0.31_1"]
    platforms=["linux/amd64"]
    context="./community/debian11"
}
