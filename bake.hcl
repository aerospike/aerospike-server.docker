...
target "enterprise_debian11" {
	 tags=["aerospike/aerospike-server-enterprise:6.1.0.8", "aerospike/aerospike-server-enterprise:6.1.0.8_1"]
	 platforms=["linux/amd64"]
	 context="./enterprise/debian11"
}

target "federal_debian11" {
	 tags=["aerospike/aerospike-server-federal:6.1.0.8", "aerospike/aerospike-server-federal:6.1.0.8_1"]
	 platforms=["linux/amd64"]
	 context="./federal/debian11"
}

target "community_debian11" {
	 tags=["aerospike/aerospike-server:6.1.0.8", "aerospike/aerospike-server:6.1.0.8_1"]
	 platforms=["linux/amd64"]
	 context="./community/debian11"
}
