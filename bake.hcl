...
target "enterprise_debian12" {
    tags=["aerospike/aerospike-server-enterprise:6.4.0.16", "aerospike/aerospike-server-enterprise:6.4.0.16_1"]
    platforms=["linux/amd64,linux/arm64"]
    context="./enterprise/debian12"
}

target "federal_debian12" {
    tags=["aerospike/aerospike-server-federal:6.4.0.16", "aerospike/aerospike-server-federal:6.4.0.16_1"]
    platforms=["linux/amd64"]
    context="./federal/debian12"
}

target "community_debian12" {
    tags=["aerospike/aerospike-server:6.4.0.16", "aerospike/aerospike-server:6.4.0.16_1"]
    platforms=["linux/amd64,linux/arm64"]
    context="./community/debian12"
}
