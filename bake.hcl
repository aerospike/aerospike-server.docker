...
target "enterprise_ubuntu20-04_amd64" {
    tags=["aerospike/aerospike-server-enterprise-amd64:6.1.0.40", "aerospike/aerospike-server-enterprise-amd64:latest"]
    platforms=["linux/amd64"]
    context="./enterprise/ubuntu20.04"
}

target "federal_ubuntu20-04_amd64" {
    tags=["aerospike/aerospike-server-federal-amd64:6.1.0.40", "aerospike/aerospike-server-federal-amd64:latest"]
    platforms=["linux/amd64"]
    context="./federal/ubuntu20.04"
}

target "community_ubuntu20-04_amd64" {
    tags=["aerospike/aerospike-server-community-amd64:6.1.0.40", "aerospike/aerospike-server-community-amd64:latest"]
    platforms=["linux/amd64"]
...
target "enterprise_ubuntu20-04" {
    tags=["aerospike/aerospike-server-enterprise:6.1.0.40", "aerospike/aerospike-server-enterprise:6.1.0.40_1"]
    platforms=["linux/amd64"]
    context="./enterprise/ubuntu20.04"
}

target "federal_ubuntu20-04" {
    tags=["aerospike/aerospike-server-federal:6.1.0.40", "aerospike/aerospike-server-federal:6.1.0.40_1"]
    platforms=["linux/amd64"]
    context="./federal/ubuntu20.04"
}

target "community_ubuntu20-04" {
    tags=["aerospike/aerospike-server:6.1.0.40", "aerospike/aerospike-server:6.1.0.40_1"]
    platforms=["linux/amd64"]
    context="./community/ubuntu20.04"
}
