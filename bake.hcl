...
target "enterprise_ubuntu22-04" {
    tags=["aerospike/aerospike-server-enterprise:7.0.0.11", "aerospike/aerospike-server-enterprise:7.0.0.11_2"]
    platforms=["linux/amd64,linux/arm64"]
    context="./enterprise/ubuntu22.04"
}

target "federal_ubuntu22-04" {
    tags=["aerospike/aerospike-server-federal:7.0.0.11", "aerospike/aerospike-server-federal:7.0.0.11_2"]
    platforms=["linux/amd64"]
    context="./federal/ubuntu22.04"
}

target "community_ubuntu22-04" {
    tags=["aerospike/aerospike-server:7.0.0.11", "aerospike/aerospike-server:7.0.0.11_2"]
    platforms=["linux/amd64,linux/arm64"]
    context="./community/ubuntu22.04"
}
