...
target "enterprise_ubuntu22-04" {
    tags=["aerospike/aerospike-server-enterprise:7.1.0.2", "aerospike/aerospike-server-enterprise:7.1.0.2_2", "aerospike/aerospike-server-enterprise:latest"]
    platforms=["linux/amd64,linux/arm64"]
    context="./enterprise/ubuntu22.04"
}

target "federal_ubuntu22-04" {
    tags=["aerospike/aerospike-server-federal:7.1.0.2", "aerospike/aerospike-server-federal:7.1.0.2_2", "aerospike/aerospike-server-federal:latest"]
    platforms=["linux/amd64"]
    context="./federal/ubuntu22.04"
}

target "community_ubuntu22-04" {
    tags=["aerospike/aerospike-server:7.1.0.2", "aerospike/aerospike-server:7.1.0.2_2", "aerospike/aerospike-server:latest"]
    platforms=["linux/amd64,linux/arm64"]
    context="./community/ubuntu22.04"
}
