...
target "enterprise_debian10_amd64" {
	 tags=["aerospike/aerospike-server-enterprise-amd64:5.7.0.30", "aerospike/aerospike-server-enterprise-amd64:latest"]
	 platforms=["linux/amd64"]
	 context="./enterprise/debian10"
}

target "community_debian10_amd64" {
	 tags=["aerospike/aerospike-server-community-amd64:5.7.0.30", "aerospike/aerospike-server-community-amd64:latest"]
	 platforms=["linux/amd64"]
...
target "enterprise_debian10" {
	 tags=["aerospike/aerospike-server-enterprise:5.7.0.30", "aerospike/aerospike-server-enterprise:5.7.0.30_1"]
	 platforms=["linux/amd64"]
	 context="./enterprise/debian10"
}

target "community_debian10" {
	 tags=["aerospike/aerospike-server:5.7.0.30", "aerospike/aerospike-server:5.7.0.30_1"]
	 platforms=["linux/amd64"]
	 context="./community/debian10"
}
