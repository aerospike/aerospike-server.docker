...
sha256="$(curl -sSL "https://www.aerospike.com/artifacts/aerospike-server-community/${fullVersion}/aerospike-server-community-${fullVersion}-debian11.tgz.sha256" | cut -d' ' -f1)"
