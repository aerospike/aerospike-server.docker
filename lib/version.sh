...
RE_VERSION='[0-9]+[.][0-9]+[.][0-9]+([.][0-9]+)+(-[a-z0-9]+)?(-[a-z0-9]+)?(-g[a-z0-9]+)?'
...
function get_version_from_dockerfile() {
    ...
    grep "ARG AEROSPIKE_X86_64_LINK=" "${edition}/${distro}/Dockerfile" | grep -oE "/[0-9]+[.][0-9]+[.][0-9]+([.][0-9]+)+(-[a-z0-9]+)?(-[a-z0-9]+)?(-g[a-z0-9]+)?/" | tr -d '/' | tail -1
}
